...
Planification et organisation pour enseignants (AdAgile).
...
Dans **`app/`** : `npm install`, configurer `.env.local` (voir `.env.local.example` à la racine du dépôt), puis `npm run dev`.
